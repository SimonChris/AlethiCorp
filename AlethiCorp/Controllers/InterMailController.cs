...
namespace AlethiCorp.Controllers
{
    public class InterMailController : InternalLayoutController
    {
        ...
        public ActionResult NameSuggestions(string term)
        {
            ...
            colors.Add("Adam Underwood");
            colors.Add("Benedetto Tornincasa");
            colors.Add("Omega");
            colors.Add("Sandra Silvern");
            colors.Add("Alpha");
            colors.Add("Oskar Jönsson");
            colors.Add("Alex DuMaurier");
            colors.Add("Andrea Schueler");
            colors.Add("Vitaly Vedenin");
